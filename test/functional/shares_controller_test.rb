...
class SharesControllerTest < ActionController::TestCase
  ...
  test "should create share" do
    assert_difference('Share.count') do
      post :create, share: { document_id: @share.document_id, encrypted_password: @share.encrypted_password, user_id: @share.user_id }
    end
  ...
  test "should update share" do
    put :update, id: @share, share: { document_id: @share.document_id, encrypted_password: @share.encrypted_password, user_id: @share.user_id }
    assert_redirected_to share_path(assigns(:share))
  end
